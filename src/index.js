    ...
    render() {
        return (
            <div className="center">
                <ButtonToolbar>
                    <Button variant="primary" className="btn btn-default" onClick={this.props.playButton}>
                        Play
                    </Button>
                    <Button variant="secondary" className="btn btn-default" onClick={this.props.pauseButton}>
                        Pause
                    </Button>
                    <Button variant="primary" className="btn btn-default" onClick={this.props.clear}>
                        Clear
                    </Button>
                    <Button variant="secondary" className="btn btn-default" onClick={this.props.slow}>
                        Slow
                    </Button>
                    <Button variant="primary" className="btn btn-default" onClick={this.props.fast}>
                        Fast
                    </Button>
